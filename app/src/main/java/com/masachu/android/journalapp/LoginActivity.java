...
import com.masachu.android.journalapp.model.User;
import com.masachu.android.journalapp.utils.Constants;
import com.masachu.android.journalapp.utils.SharedPrefManager;
import com.masachu.android.journalapp.utils.Utils;
...
public class LoginActivity extends MainActivity implements GoogleApiClient.ConnectionCallbacks,
                        ...
                        .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    createUserInFirebaseHelper(email,photo);
     ...
     * @param email
     */
    private void createUserInFirebaseHelper(String email, final String photo) {
          final String s = "";
        ...
        userLocation.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            ...
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() == null){
                    ...
                    User newUser = new User(name, s, encodedEmail, timestampJoined);
